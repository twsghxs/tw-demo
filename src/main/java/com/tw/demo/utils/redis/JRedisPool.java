...
public class JRedisPool {
	...
	public JRedisPool(final GenericObjectPoolConfig poolConfig, final String host, int timeout, final String password) {
	...
	public JRedisPool(final GenericObjectPoolConfig poolConfig, final String host, int timeout, final String password, final int database, final boolean randomRead) {
