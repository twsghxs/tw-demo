...
public class RouteData {
	...
	public RouteData(ServerInfo info) {
		this(info, new JedisPool(info.getPoolConfig(), info.getHost(), info.getPort(), info.getTimeout(), info.getPassword()));
	}
	...
	public JedisPool createJedisPool() {
		return new JedisPool(info.getPoolConfig(), info.getHost(), info.getPort(), info.getTimeout(), info.getPassword());
	}
	...
	public boolean equals(Object obj) {
		...
		if (this.info.getHost().equals(route.getInfo().getHost()) && this.info.getPort() == route.getInfo().getPort()) {
			return true;
		}
